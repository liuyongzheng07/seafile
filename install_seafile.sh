...
function install_sea() {
	cd /home/MyCloud
	#下载安装包6.0.9 64bit
	wget "https://download.seafile.com/d/6e5297246c/files/?p=/pro/seafile-pro-server_6.3.6_x86-64.tar.gz&dl=1" -O seafile-pro-server_6.3.6_x86-64.tar.gz
	#解压
	tar -zxvf seafile-pro-server_6.3.6_x86-64.tar.gz
	mkdir installed
	mv seafile-pro-server_6.3.6_x86-64.tar.gz ./installed
	mv seafile-pro-server_6.3.6_x86-64.tar.gz seafile-server
	#安装依赖环境
	yum -y install python-setuptools python-imaging python-ldap MySQL-python python-memcached python-urllib3 jre
	#进行安装
	cd seafile-pro-server-6.3.6 && ./setup-seafile.sh
